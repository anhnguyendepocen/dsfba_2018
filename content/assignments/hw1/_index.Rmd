...
__2.b__  Print out the mtcars data frame sorted by hp (descending oder).

__2.c__ Create a new object named `cars_cyl` and assign to it the `mtcars` data frame grouped by the number of cylinders, removing all variables except the average miles per US gallon and gross horsepower for each cylinder group.
